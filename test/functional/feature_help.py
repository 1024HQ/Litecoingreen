...
"""Verify that starting litecoingreen with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litecoingreen with -h for help text")
        ...
        self.log.info("Start litecoingreen with -version for version information")
        ...
        self.log.info("Start litecoingreend with -fakearg to make sure it does not start")
