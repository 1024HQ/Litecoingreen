...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litecoingreen-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  litecoingreen-tx [options] <hex-tx> [commands]  Update hex-encoded litecoingreen transaction\n" +
            "or:     litecoingreen-tx [options] -create [commands]   Create hex-encoded litecoingreen transaction\n" +
            "\n";
