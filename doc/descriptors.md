# Support for Output Descriptors in Litecoingreen Core

Since Litecoingreen Core v0.17, there is support for Output Descriptors. This is a
...
on Litecoingreen's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Litecoingreen Core wallets, a convenience function `combo` is
