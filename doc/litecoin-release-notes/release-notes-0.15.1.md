Litecoingreen Core version *0.15.1* is now available from:

  <https://download.litecoingreen.org/litecoingreen-0.15.1/>
...
A number of changes to the way Litecoingreen Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mLTCG per kB (0.00001 LTCG). This is to prepare for dropping the minimum transaction fee to 0.1 mLTCG per kB (0.0001 LTCG) in the next release.
